...
export class NgxIntlTelInputComponent implements OnInit, OnChanges {
  ...
  public searchCountry() {
    ...
    let countrySearchTextLowerToBeChecked = this.countrySearchText.toLowerCase();
    if(countrySearchTextLowerToBeChecked.includes("+")) {
      countrySearchTextLowerToBeChecked = countrySearchTextLowerToBeChecked.replace("+", "");
    }
    console.log(countrySearchTextLowerToBeChecked)
    const countrySearchTextLower = countrySearchTextLowerToBeChecked;
    ...
    const country = this.allCountries.filter((c) => {
      if (this.searchCountryField.indexOf(SearchCountryField.All) > -1) {
        ...
        if (c.dialCode.startsWith(countrySearchTextLower)) {
          return c;
        }
      } else {
